...
public sealed class ClaudeAiProvider : IAiProvider
{
        ...
        CancellationToken ct = default)
    {
        ...
        var prompt = $"""
            ...
            7. Output a complete HTML document with absolutely no styling (clean sans-serif font, no bold/italid/underlined/highlighted text, comfortable line-height, max-width ~700px, standard letter margins). No header/footer chrome — just the letter body.

...
public record ApplicationResponse
{
    ...
    /// <summary>Gets a value indicating whether a letter generation job is currently in progress.</summary>
    public required bool IsLetterGenerationPending { get; init; }

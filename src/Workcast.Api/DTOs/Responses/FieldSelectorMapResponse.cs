...
/// <summary>
/// Response representation of the per-field CSS selectors used to extract job ad data
/// from each job card element on a listing page.
/// </summary>
public record FieldSelectorMapResponse
{
    ...
    /// <summary>Gets the CSS selector or attribute expression for a board-specific job identifier.</summary>
